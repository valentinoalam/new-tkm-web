    ...
    <nav id="header" class="fixed top-0 z-30 w-full text-white">
      ...
      >
        ...
        <div class="block pr-4 lg:hidden">
          <button
            id="nav-toggle"
            class="flex items-center px-3 py-2 text-gray-500 border border-gray-600 rounded appearance-none hover:text-gray-800 hover:border-teal-500 focus:outline-none focus:ring focus:ring-teal-500"
          >
            <svg
        ...
        >
          <ul class="items-center justify-end flex-1 list-reset lg:flex">
            <li class="mr-3">
              <a
                class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-gray-800 focus:text-gray-800 focus:outline-none focus:underline"
                href="#"
                >Active</a
              >
            </li>
            <li class="mr-3">
              <a
                class="inline-block px-4 py-2 text-black no-underline hover:text-gray-800 hover:underline focus:text-gray-800 focus:outline-none focus:underline"
                href="#"
                >Link</a
              >
            </li>
          ...
          <button
            id="navAction"
            class="px-8 py-4 mx-auto mt-4 font-bold text-gray-800 bg-white rounded-full shadow opacity-75 lg:mx-0 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring focus:ring-gray-200 lg:mt-0"
          >
            Action
          </button>
        </div>
          ...
          <div class="flex-1">
            ...
            <ul class="mb-6 list-reset">
              <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                <a
                  href="#"
                  class="text-gray-800 no-underline hover:underline hover:text-orange-500"
                  >FAQ</a
                >
              </li>
              <li class="inline-block mt-2 mr-2 md:block md:mr-0">
  ...
  setup() {
    ...
    const handleScroll = () => {
      ...
      if (scrollPos > 10) {
        ...
        navAction.value.classList.remove('bg-white');
        navAction.value.classList.add('gradient');
        navAction.value.classList.remove('text-gray-800');
        navAction.value.classList.add('text-white');

        toToggle.value.forEach(el => {
        ...
        navAction.value.classList.remove('gradient');
        navAction.value.classList.add('bg-white');
        navAction.value.classList.remove('text-white');
        navAction.value.classList.add('text-gray-800');
    ...
    // Function to handle outside click for menu
    const handleOutsideClick = e => {
      const target = e.target;

      if (!checkParent(target, navContent.value)) {
        if (checkParent(target, navToggle.value)) {
          navContent.value.classList.toggle('hidden');
        } else {
          navContent.value.classList.add('hidden');
        }
      }
    };

    // Helper function to check if clicked target is a child of an element
